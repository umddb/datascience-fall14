...
echo 'export PATH=/home/terrapin/cloudera/cdh5.1/hadoop-2.3.0-cdh5.1.2/bin:/home/terrapin/cloudera/cdh5.1/hadoop-2.3.0-cdh5.1.2/sbin:/usr/lib/jvm/java-7-openjdk-i386/jre/bin:${PATH}' >> ~/.profile
source $HOME/.profile
cd -
